...
from notifications.models import EmailLogModel
from .email_template import EmailTemplateService
from notifications.exceptions import EmailSendError
from notifications.repositories import EmailLogRepository

logger = logging.getLogger("notifications.email-service")
...
class EmailService:
    ...
    def send_email(
        ...
        try:
            ...
            logger.info(
                f"Email sent | to={recipient_email}, template={template.slug}, subject={subject}"
            )
            return email_log
